DeClaim – Breaking Claims into Logic
...
3. AI analyzes the claim using structured logic  
4. Generates:
   - Fake percentage  
   - Bias and emotion scores  
   - Explanation  
   - Corrected version of claim  
5. Updates user Skeptic Score  
...
- AI may struggle with highly technical topics  
